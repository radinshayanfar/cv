...
\begin{itemize}
  ...
  \item Analyzed agent outputs on LiveCodeBench (LCB); identified model-side anomalies and harness/evaluation defects that masked true capability signal.
  \item Lifted gold-patch resolution on FeatBench from \textbf{37.31\%}\,{\small$\pm$\,1.88} to \textbf{99.81\%}\,{\small$\pm$\,0.10} by diagnosing harness and environment defects in the original benchmark; released FeatBench-Verified v1.3 to the community.
\end{itemize}
