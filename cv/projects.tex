...
\cventry
    ...
    {Speaker-specific Voice Activity Detection with ECAPA-TDNN Embeddings} % Project
    {} % Location
    {Fall 2024} % Date
    {
      \begin{cvitems}
...
\cventry
    ...
    {Comparative Analysis of Transformer-based Models for Sentiment Analysis} % Project
    {} % Location
    {Fall 2023} % Date
    {
      \begin{cvitems}
